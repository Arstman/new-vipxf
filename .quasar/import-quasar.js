...
Vue.use(Quasar, { config: {},lang: lang,components: {QLayout,QHeader,QDrawer,QPageContainer,QPage,QToolbar,QToolbarTitle,QBtn,QIcon,QList,QItem,QItemSection,QItemLabel},directives: {Ripple},plugins: {Notify} })
